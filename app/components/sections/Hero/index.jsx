  ...
  return (
    <FullWidthLayout className="bg-brand-dark">
      <div className="relative isolate pt-14">
        ...
        >
          <div
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/3 rotate-[50deg] bg-gradient-to-tr from-indigo-100 to-blue-400 opacity-30 sm:left-[calc(50%-30rem)] sm:w-[80rem]"
            style={{
              clipPath:
