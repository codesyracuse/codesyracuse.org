  ...
  return (
    <FullWidthLayout className="bg-brand-dark">
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        >
          <div
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] overflow-hidden bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
...
export function BoringHero({ image, title, description, cta, secondaryCta }) {
  return (
    <FullWidthLayout>
      <div className="relative mb-2 bg-gray-300 md:mb-6">
