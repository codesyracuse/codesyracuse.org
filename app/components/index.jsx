...
const navigation = {
  social: [
    {
      name: "Facebook",
      href: "https://www.facebook.com/CODESyracuse",
      icon: (props) => (
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/CODESyracuse",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "YouTube",
      href: "https://www.youtube.com/user/CODESyracuse",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
...
export default function Footer2({ footerNavigation }) {
      ...
      <div className="sm:pt-18 mx-auto max-w-7xl px-6 pb-8 pt-12 lg:px-8 lg:pt-24">
        <div className="md:grid md:grid-cols-2 md:gap-8">
          ...
          <div className="mt-10 md:mt-0">
            ...
            <form className="mt-18 sm:flex sm:max-w-md">
              <label htmlFor="email-address" className="sr-only">
                Email address
              </label>
              <input
